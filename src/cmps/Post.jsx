    ...
    return (
        <div className="post" key={post._id}>
            ...
            <div className="buttons">
                <div className={`like ${userLikesPost && 'red'}`} onClick={() => userLikesPost ? interactionService.unlikePost(post, fullLoggedInUser) : interactionService.likePost(post, fullLoggedInUser)}>
                    {userLikesPost
                ...
                <div className="comment" onClick={() => navigate(`/${post.by.username}`)}>
