...
import { SET_MODAL } from '../store/reducers/post.reducer';
...
export function SideBar() {
    ...
    return (
        <article className="side-bar">
            <div className="logo-btn" onClick={() => setPage('home')}>
            ...
            <div className="create-btn" onClick={() => { setPage('create'), dispatch({ type: SET_MODAL, modal: { open: true } }) }}>
