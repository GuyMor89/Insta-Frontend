        ...
        <article className="side-bar">
            ...
            <div className="home-btn" onClick={() => setPage('home')}>
                {page === 'home'
                    ...
                    : <svg fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Home</title><path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
                }
                <span className={page === 'home' && 'bold'}>Home</span>
            </div>
            <div className="search-btn" onClick={() => setPage('search')}>
                {page === 'search'
                    ? <svg fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Search</title><path d="M18.5 10.5a8 8 0 1 1-8-8 8 8 0 0 1 8 8Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" x1="16.511" x2="21.643" y1="16.511" y2="21.643"></line></svg>
                    : <svg fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Search</title><path d="M19 10.5A8.5 8.5 0 1 1 10.5 2a8.5 8.5 0 0 1 8.5 8.5Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="16.511" x2="22" y1="16.511" y2="22"></line></svg>
                }
                <span className={page === 'search' && 'bold'}>Search</span>
                </div>
            <div className="explore-btn" onClick={() => setPage('explore')}>
                {page === 'explore'
            ...
            <div className="messages-btn" onClick={() => setPage('messages')}>
                {page === 'messages'
                ...
                <span className={page === 'messages' && 'bold'}>Messages</span>
                </div>
            <div className="create-btn" onClick={() => setPage('create')}>
            ...
            <div className="profile-btn" onClick={() => setPage('profile')}>
                <img className={page === 'profile' && 'bold'} src='https://res.cloudinary.com/dtkjyqiap/image/upload/v1736381008/profile_pirpak.jpg'></img>
                <span className={page === 'profile' && 'bold'}>Profile</span>
            </div>
            <div className="more-btn" onClick={() => setPage('more')}>
                {page === 'more'
